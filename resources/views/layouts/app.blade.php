...
<link rel="shortcut icon" type="image/x-icon" href="{{url('assets/imgs/theme/favicon.icon')}}">
<link rel="stylesheet" href="{{url('assets/css/main.css')}}">
<link rel="stylesheet" href="{{url('assets/css/custom.css')}}"></head>
@livewireStyles
<body>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Surfside Media" src="{{asset('assets/imgs/shop/product-')}}{{$item->id}}-2.jpg"></a>
                                                </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{route('admin.homesliders')}}">Slider</a></li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{route('user.dashboard')}}">Setting</a></li>
                                            <li><a href="{{route('user.dashboard')}}">Dashboard</a></li>
                                        </ul>
                                        @endif
                                    </li>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+880) 1728593265 </p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">E-Shop</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
...
<!-- Template  JS -->
<script src="{{url('assets/js/main.js?v=3.3')}}"></script>
<script src="{{url('assets/js/shop.js?v=3.3')}}"></script>
