                ...
                <div class="card-body">
                    <form wire:submit.prevent="EditSlider()">
                        ...
                        <div class="mb-2 mt-2">
                            ...
                            <input type="file" class="form-control" name="newimage" wire:model="photo" id="newimage" >
                            @if($photo)
                                <img src="{{ $photo->temporaryUrl()}}" width="100px" height="100px">
                            @else
                                <img src="{{asset('assets/imgs/slider')}}/{{$image}}" class="img" width="100px" height="100px">
                            @endif
                            @error('image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
