                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/shop/product-')}}{{$products->id}}-2.jpg" alt="{{$products->name}}">
                                            </figure>
                                            <figure class="border-radius-10">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">{{$products->sale_price }}</span></ins>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up mb-0">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="product-details.html" tabindex="0">
                                                            <img class="default-img" src="{{asset('assets/imgs/shop/product-')}}{{$relate->id}}-1.jpg" alt="">
                                                            <img class="hover-img" src="{{asset('assets/imgs/shop/product-')}}{{$relate->id}}-2.jpg" alt="">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="product-details.html" tabindex="0"> {{$relate->name}} </a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span> {{$relate->sale_price}} </span>
                                                        <span class="old-price"> {{$relate->regular_price}} </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{asset('assets/imgs/shop/product-')}}{{$latests->id}}-2.jpg" alt="#">
                                </div>
                                <div class="content pt-10">
                                    <h5><a href="product-details.html"> {{$latests->name}} </a></h5>
                                    <p class="price mb-0 mt-5"> {{$latests->sale_price}} </p>
